"""
Main Execution Entry Point for Compliance AI.
...
load_dotenv()  # override=True means .env values take priority over system variables
...
logger = logging.getLogger("compliance-qa-runner")  # Creates a named logger for this module
